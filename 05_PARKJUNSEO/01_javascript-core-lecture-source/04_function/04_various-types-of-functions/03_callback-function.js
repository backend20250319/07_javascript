...
console.log(apply(increase, 5) - apply(decrease, 5));

// 콜백함수가 고차함수 내부에서만 호출된다면
// 익명함수 리터럴로 정의하면서 전달하는 것이 일반적이다.
console.log(
...
// 함수의 변하지 않는 공통 로직을 미리 정의해두고 경우에 따라 변경되는 로직은
// 추상화해서 함수의 외부에서 내부로 전달하는 방식이다.
// 비동기처리(이벤트, 타이머...)에서 활용되는 중요한 패턴이며
// 배열 고차 함수에서도 활용된다.
