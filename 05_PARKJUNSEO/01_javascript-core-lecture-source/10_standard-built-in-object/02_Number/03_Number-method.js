...
console.log(Number.isFinite(-Infinity)); // false
console.log(Number.isFinite(NaN)); // false // 숫자 타입인 경우에만 검사함 (형변환 x -> 숫자가 아니므로 false 반환)
console.log(Number.isFinite(null)); // false // 숫자 타입인 경우에만 검사함 (형변환 x -> 숫자가 아니므로 false 반환)
console.log(isFinite(null)); // true // 빌트인 전역함수 isFinite는 암묵적 타입변환을 한다.
console.log(`===================================================`);
