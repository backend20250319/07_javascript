...
// 검색 시작 인덱스 지정
console.log(str1.includes("a", 2)); // true
// 특정 문자열 존재 유무 확인에 사용
if (str1.includes("a")) console.log("a가 있다");
console.log(`===============================`);

// String.prototype.search
/* 인수로 전달 받은 정규 표현식과 매치하는 문자열을 검색하여 일 치하는 문자열 인덱스를 반환 */
const str2 = "JavaScript";
console.log(str2.search(/a/)); // 1
console.log(str2.search(/b/)); // -1 (검색 실패)
console.log(`===============================`);
...
// 검색 시작 인덱스 지정
console.log(str3.startsWith("va", 2)); // true
// 'pt'로 끝나는지
console.log(str3.endsWith("pt")); // true
// 기준 인덱스 지정
console.log(str3.endsWith("va", 4)); // true
console.log(`===============================`);

// String.prototype.charAt
/* 문자열에서 특정 인덱스에 위치하는 유니코드 단일문자를 반환 */
const str4 = "JavaScript";
for (let i = 0; i < str4.length; i++) console.log(str.charAt(i));
console.log(`===============================`);
...
console.log(str5.substring(1, 20)); // "avaScript"
console.log(`===============================`);

// String.prototype.slice
/* 문자열의 일부를 추출하면서 새로운 문자열을 반환 */
/* substring과 동일하게 동작하지만 음수인 인수를 전달하면 가장 뒤에서부터 시작하여 잘라내 반
환 */
const str6 = "JavaScript";
// substring 동일
console.log(str6.slice(1, 4)); // "ava"
// substring 동일
console.log(str6.slice(1)); // "avaScript"
// 인수 교환하여 기능하지 않음
console.log(str6.slice(4, 1)); // ""
// 음수는 뒤에서부터
console.log(str6.slice(-1)); // "t"
// substring 동일
console.log(str6.slice(1, 20));
console.log(`===============================`);
...
console.log(str7.toUpperCase()); // "JAVASCRIPT"
console.log(str7.toLowerCase()); // "javascript"
console.log(`===============================`);

// String.prototype.trim
/* 문자열 앞뒤 공백 문자 제거 후 반환 */
const str8 = " JavaScript ";
console.log(str8.trim()); // "JavaScript"
console.log(`===============================`);

// String.prototype.repeat
/* 전달받은 정수만큼 반복해 연결한 새로운 문자열을 반환 */
const str9 = "JavaScript";
console.log(str9.repeat()); // ""
console.log(str9.repeat(0)); // ""
console.log(str9.repeat(1)); // "JavaScript"
console.log(str9.repeat(2)); // "JavaScriptJavaScript"
// 실수는 정수로 처리
console.log(str9.repeat(2.5)); // "JavaScriptJavaScript"
// 음수는 에러
// console.log(str.repeat(-1)); // RangeError: Invalid count value
console.log(`===============================`);

// String.prototype.replace
/* 첫번째 인수로 전달 받은 문자열 또는 정규표현식을 검색하여 두번째 인수로 전달한 문자열로 치
환한 문자열 반환 */
...
루어진 배열 반환 */
const str10 = "Hello, Everyone! Nice to see you again.";
console.log(str10.split(" ")); // 공백을 구분하여 배열로 반환
console.log(str10.split("")); // 인수로 빈 문자열을 전달하면 각 문자를 모두 분리
console.log(str10.split()); // 인수를 생략하면 문자열 전체를 단일 요소로 하는 배열 반환
console.log(str10.split(" ", 5)); // 두번째 인수로 배열의 길이 지정
console.log(`===============================`);
