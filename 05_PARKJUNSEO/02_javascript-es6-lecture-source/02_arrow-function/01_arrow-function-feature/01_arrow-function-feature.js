// 화살표 함수 특징
// 화살표 함수는 기존의 함수보다 표현이 간략한 것뿐만 아니라 내부 동작 또한 간략화 되어 있다.

// 1. 화살표 함수는 this를 가지지 않는다.
const theater = {
  store: "건대점",
  titles: ["어벤져스", "해리포터", "겨울왕국"],
  showMovieList() {
    // 일반 함수
    this.titles.forEach(function (title) {
      console.log(this); // --> 일반함수의 this는 전역객체 (global)를 가리킨다.
...
(function () {
  ...
  // 화살표 함수는 본인의 arguments 3, 4,가 아닌 상위스코프의 arguments 1, 2를 참조한다.
  // const arrwoFunc = () => console.log(arguments);
