...
// 콜백 함수가 고차함수 내부에만 호출된다면
// 익명 함수 리터럴로 정의하면서 전달하는것이 일반적이다.
console.log(
...
// 함수의 변하지 않는 공통 로직을 미리 정의해두고 경우 따라 변경되는 로직
// 추상화 해서 함수의 외부에서 내부로 전달하는 방식
// 비동기 처리(이벤트, 타이머, ...)에서 활용되는 중요한 패턴
// 배열 고차 함수에서도 활용된다.
console.log([3, 1, 4, 2, 5].sort((a1, a2) => a2 - a1));
