...
const theater = {
  ...
  showMovieList() {
    ...
    this.titles.forEach(function (title) {
      console.log(this); // => 일반 함수의 this는 전역 객체 (global)를 가리킨다.
      console.log(`${this.store} : ${title}`);
    });

    // 화살표 함수
    //this.titles.forEach((title) => console.log(this));
...
// 상위 스코프를 그대로 참조하도록 설계되어 ES6 콜백 함수에서 자주 발생하던
// this 바인딩 문제(전역 객체 or undefinded를 가리킴)을 간편하게 해결할 수 있다.
