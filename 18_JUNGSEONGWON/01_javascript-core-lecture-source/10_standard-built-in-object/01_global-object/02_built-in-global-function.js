...
// isFinite
// 전달 받은 인수가 정상적인 유한수인지 검사하여 유한수이면 true를 반환하고, 
// 무한수이면 false를 반환한다.전달 받은 인수가 숫자가 아닌 경우 숫자로 타입 변환 후 
...
// ? 뒤에는 get 방식이다. url로 요청하는 것은 전부 다 get 방식이다.
...
// 구성 요소를 인수로 전달 받아 알파벳, 0~9의 숫자, - _ . ! ~ * ’ ( ) 문자는 제외하고 인코딩한다.
