// flag and pattern
// 플래그 문자 : flag는 옵션이므로 선택적으로 사용할 수 있고, 순서와 상관 없이 하나 이상의 플래그를 동시에 설정할 수 있다.
...
console.log(`===================================================`);
 ...
 // $ : 마지막 위치 검색 , com으로 끝나는지 검사 con으로 바꾸면 false
console.log(/com$/.test(target)); // true
 
// https://regexper.com/#%2F%5E%5BA-Za-z0-9%5D%7B6%2C12%7D%24%2F 정규표현식 시각화 해주는 사이트
